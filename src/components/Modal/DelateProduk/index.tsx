...
interface ModalHapusprodukProps {
    isOpen: boolean;
    onClose: () => void;
}

const ModalHapusproduk: React.FC<ModalHapusprodukProps> = ({
    isOpen,
    onClose,
}) => {
    ...
    return (
        <div className="fixed flex inset-0 items-center justify-center z-50 bg-black bg-opacity-50">
            <div className="relative flex flex-col w-full max-w-md p-6 bg-white animate-popup rounded-lg shadow-lg">
                ...
                <p className="text-abu text-center">Anda Yakin Ingin Menghapus Produk?</p>
