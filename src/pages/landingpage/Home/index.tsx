...
export default function Home({ className }: HomeProps) {
    return (
        <div className={`flex flex-col md:flex-row ${className} px-4 md:px-1 space-y-6 md:space-y-0 md:space-x-10`}>
            {/* Teks dan Tombol */}
            <div className="w-full md:w-1/2 h-full flex flex-col space-y-6">
                {/* Heading */}
                <div className="h-auto md:h-3/6 flex items-start justify-start">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-start space-x-4">
                        ...
                        <button className="h-12 w-36 border border-gray-300 rounded-3xl hover:border-unik duration-300 ease-in-out text-unik">Layanan Kami</button>
                    </div>
                </div>
            </div>
